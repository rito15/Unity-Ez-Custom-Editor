...
namespace Rito.EditorUtilities
{
    ...
    {
        public static Button Default => ThemeDict[EzEditorUtility.DefaultColorTheme];
        public static readonly Dictionary<EColor, Button> ThemeDict = new Dictionary<EColor, Button>()
        {
            { EColor.Gray   , Gray    },
            { EColor.White  , White   },
            { EColor.Black  , Black   },
    ...
    {
        public static ToggleButton Default => ThemeDict[EzEditorUtility.DefaultColorTheme];
        public static readonly Dictionary<EColor, ToggleButton> ThemeDict = new Dictionary<EColor, ToggleButton>()
        {
            { EColor.Gray   , Gray    },
            { EColor.White  , White   },
            { EColor.Black  , Black   },
