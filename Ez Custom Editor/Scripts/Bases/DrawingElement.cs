...
namespace Rito.EditorUtilities
{
    ...
    public abstract class DrawingElement<T, R> : GUIElement<R> where R : DrawingElement<T, R>
    {
        ...
        {
            Draw(EZU.LayoutXLeft, EZU.LayoutXRight, 0f, EZU.LayoutControlHeight,
                EZU.LayoutXLeftOffset, EZU.LayoutXRightOffset);
            EZU.Space(EZU.LayoutControlHeight + EZU.LayoutControlBottomMargin);
        ...
        {
            Draw(xLeft, xRight, 0f, EZU.LayoutControlHeight, EZU.LayoutXLeftOffset, EZU.LayoutXRightOffset);
            EZU.Space(EZU.LayoutControlHeight + EZU.LayoutControlBottomMargin);
        ...
        {
            Draw(xLeft, xRight, 0f, EZU.LayoutControlHeight, xLeftOffset, xRightOffset);
            EZU.Space(EZU.LayoutControlHeight + EZU.LayoutControlBottomMargin);
